	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TO_DO - Indicate result and finish
		...
		// TO_DO - Set up OnClickListener for the Reset Button
		...
		resetButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TO_DO - Reset data to default values
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TO_DO - Get the current Priority
				Priority priority = getPriority();

				// TO_DO - Get the current Status
				Status status = getStatus();

				// TO_DO - Get the current ToDoItem Title
				...
				// TO_DO - return data Intent and finish
